...
export type CustomerHeaderQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;

export type CustomerHeaderQuery = {
  customer: Pick<
    CustomerAccountAPI.Customer,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CustomerHeader($language: LanguageCode)\n  @inContext(language: $language) {\n    customer {\n      id\n      firstName\n      lastName\n      displayName\n      companyContacts(first: 1) {\n        nodes {\n          company {\n            name\n          }\n        }\n      }\n    }\n  }\n': {
    return: CustomerHeaderQuery;
    variables: CustomerHeaderQueryVariables;
  };
